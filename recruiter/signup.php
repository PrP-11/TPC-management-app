      ...
      if(SHA1($captcha) == $_SESSION['passphrase']){
        if(!empty($company_id) && !empty($company_name) &&
          ...
          if(mysqli_num_rows($data) == 0){
            ...
            $query = "INSERT INTO recruiters (company_id, company_name, company_status, hr_name, hr_email, password, join_date) VALUES ".
              "('$company_id', '$company_name', 'pending', '$hr_name', '$hr_email', SHA('$password'), NOW())";
